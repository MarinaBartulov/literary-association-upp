...
insert into book (isbn, num_of_pages, open_access, pdf, price, publishers_address, synopsis, title, year, editor_id, genre_id, lecturer_id, publisher_id, writer_id) value ('1234567891234', 100, false, '/uploaded-files/proces/knjiga.pdf',10.59, 'Bulevar oslobodjenja 34', 'Ovo je knjiga bla bla bla','Mentalni sklop','2015',5,7,9,1,6);
insert into book (isbn, num_of_pages, open_access, pdf, price, publishers_address, synopsis, title, year, editor_id, genre_id, lecturer_id, publisher_id, writer_id) value ('1234567333333', 150, false, '/uploaded-files/proces/knjiga.pdf',17.50, 'Bulevar Mihajla Pupina 23', 'Ovo je druga knjiga bla bla bla','Zora u crnoj sumi','2015',5,1,9,2,6);