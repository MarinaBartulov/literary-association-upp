...
value ('BoardMember', 'board.member1@gmail.com', '$2a$10$MgS2lefNxeyaDHxP/inYO.D0G5bkS8OX5RbAj7MJgghT16n6dQwIe', 'boardMember1', 'Pera', 'Peric', 'NS', 'Srbija', true, true);

insert into user (type, email, password, username, first_name, last_name, city, country, verified, enabled)
value ('BoardMember', 'board.member2@gmail.com', '$2a$10$MgS2lefNxeyaDHxP/inYO.D0G5bkS8OX5RbAj7MJgghT16n6dQwIe', 'boardMember2', 'Mika', 'Mikic', 'NS', 'Srbija', true, true);
